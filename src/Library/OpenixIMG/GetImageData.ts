 ...
 *
 * @param packer - OpenixPacker instance with loaded image
 ...
 */
export function checkSecureFirmware(packer: OpenixPacker): boolean | null {
 ...
 */
export async function getBootPackageData(packer: OpenixPacker): Promise<Uint8Array | null> {
